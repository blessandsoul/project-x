...
// Correct column names based on user feedback (using description_en instead of description)
// Assuming standard prefixes from schema.sql: description_en, description_ka, description_ru
// We will populate all 3 with the same text to be safe, or just En.
let sql = "-- Insert 20 Companies linked to company1@gmail.com ... company20@gmail.com\n";
sql += "-- Used columns: description_en, description_ka, description_ru instead of description\n\n";
...
for (let i = 1; i <= 20; i++) {
    ...
    // We update the INSERT to use the specific language columns
    sql += `INSERT INTO companies (owner_user_id, name, slug, country, city, state, phone_number, contact_email, is_active, description_en, description_ka, description_ru, base_price, price_per_mile)

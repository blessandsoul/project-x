                            ...
                            <div className="space-y-2 flex-1">
                                ...
                                {highlights.length > 0 && (
                                    <div className="flex flex-wrap gap-2 mt-2">
                                        {highlights.map(h => (
                                            <Badge key={h} className="bg-emerald-600/10 text-emerald-700 border-emerald-200 hover:bg-emerald-600/20 shadow-none px-2.5 py-0.5 text-xs">
                                                {h}
                                            </Badge>
                                        ))}
                                    </div>
            ...
            <div className="lg:col-span-1 space-y-4 lg:sticky lg:top-24">
                ...
                {estimatedImportCost && (
                    <Card className="border-none shadow-lg bg-accent text-slate-900 overflow-hidden relative">
                        ...
                        <CardContent className="p-5 relative z-10 space-y-4">
                            ...
                            <Button className="w-full font-bold bg-primary hover:bg-primary/90 text-white shadow-md" onClick={handleGoToCatalog}>
                ...
                <Card className="border border-slate-200 shadow-sm bg-white">
                    <CardContent className="p-5 space-y-4">
                        ...
                        <Button onClick={handleGoToCatalog} size="lg" className="w-full font-bold bg-primary hover:bg-primary/90 text-white shadow-md">
                            {t('vin.show_matches')}

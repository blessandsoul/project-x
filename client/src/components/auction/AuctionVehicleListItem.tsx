...
export function AuctionVehicleListItem({
  ...
  return (
    <tr className={cn(
      ...
      <td className="align-top whitespace-normal lg:whitespace-nowrap break-words p-2 responsive-image-cell px-1 overflow-visible">
        <div className="flex gap-2">
          ...
          <div className={cn(
            "relative aspect-[4/3] rounded-md overflow-hidden bg-muted responsive-image",
            showCompareCheckbox ? "w-[140px]" : "w-48"
          )}>
            <button
              type="button"
      ...
      <td className="align-top whitespace-normal lg:whitespace-nowrap break-words p-2 overflow-hidden">
        <div className="max-w-[140px] pl-2">
          ...
          <div className="text-muted-foreground mt-0.5 text-[11px]">
            {t('auction.lot')} <span className="text-primary font-medium">{item.source_lot_id || 'N/A'}</span>
          </div>
      ...
      {/* Vehicle Info Column (flex) - Hidden when hideExtraColumns is true */}
      {!hideExtraColumns && (
        <td className="align-top whitespace-normal lg:whitespace-nowrap break-words p-2 overflow-hidden">
          <div>
      ...
      {/* Document Column (renamed from Condition) - Hidden when hideExtraColumns is true */}
      {!hideExtraColumns && (
        <td className="align-top whitespace-normal lg:whitespace-nowrap break-words p-2 overflow-hidden">
